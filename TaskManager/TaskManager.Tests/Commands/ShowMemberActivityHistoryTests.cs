...
{
    [TestClass]
    public class ShowMemberActivityHistoryTests
    {
        ...
        {
            ICommand command = this.commandFactory.Create("ShowMemberActivityHistory");
            command.Execute();
        }
        ...
        {
            ICommand command = this.commandFactory.Create("ShowMemberActivityHistory MemberOne");
